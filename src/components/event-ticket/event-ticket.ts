            ...
            <svg width="0" height="0">
                <defs>
                    ...
                    <clipPath id="ticketClipPathVert" clipPathUnits="objectBoundingBox" transform="scale(0.001, 0.0011628)">
                        <path class="cls-1" d="M1000,466.39v-430A36.37,36.37,0,0,0,963.63,0H36.37A36.37,36.37,0,0,0,0,36.37V467.06a31.76,31.76,0,0,1,31.77,31.78A31.76,31.76,0,0,1,0,530.61v293A36.37,36.37,0,0,0,36.37,860H963.63A36.37,36.37,0,0,0,1000,823.63V529.94a31.78,31.78,0,0,1,0-63.55Z"/>
                    </clipPath>
                </defs>
            </svg>
